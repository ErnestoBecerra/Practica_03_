...
imgpath = '/home/carlile/Descargas/IMG/'
...
def generarGrafica(ultima_lectura,dato,title,d1,d2,d3):
    ...
    ret = rrdtool.graphv( imgpath+ title + ".png",
                    ...
                    '--lower-limit', '0',
                    '--upper-limit', '100',
                    "--title=Carga del" + title + "\n Detección de umbrales \n Sanchez Becerra Ernesto Daniel",
...
pathImage = "/home/carlile/Descargas/IMG/useCPU.png"
envioCPU30 = True
envioCPU75 = True
envioCPU80 = True
...
while (1):
    ...
    if CPU_data> 80 and envioCPU80:
        pathImage = "/home/carlile/Descargas/IMG/CPU.png"
    ...
    if RAM_data> 80 and envioRAM80:
        pathImage = "/home/carlile/Descargas/IMG/RAM.png"
